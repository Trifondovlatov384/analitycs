...
Локальный интерактивный дашборд по сделкам из `july2026.csv` (экспорт bnMAP по Крыму; при необходимости можно подставить свой CSV).
...
- `july2026.csv` / `june2026.csv` / `may2026.csv` — bnMAP по Крыму (берётся более новый файл, сейчас **july2026** с данными до июня 2026)
...
```bash
DATA_PATH="/полный/путь/к/july2026.csv" python app.py
BNMAP_EXPORT_PATHS="may2026.csv,july2026.csv" python app.py  # несколько выгрузок bnMAP
